...
<body>
    ...
    <nav class="sidebar">
        <div class="sidebar-header">
            <span class="logo">Bang Tarno</span>
        </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        while ($data = mysqli_fetch_assoc($query)) {
                            ...
                            echo "<td>
                                    <a class=\"action-btn\" href=\"../Handling/cetak_struk.php?id_order=" . urlencode($data['id_order']) . "\" target=\"_blank\" title=\"Cetak Struk\">
