  ...
  <div class="main-content">
        ...
        <div class="content-container">
            ...
            <div class="content-body">
                <form action="../Handling/tambah_menu.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="harga_menu" name="harga_menu"  required>
                    </div>
                    <div class="form-group">
                        <label for="harga_jual">Harga Jual</label>
                        <input type="text" id="harga_menu" name="harga_jual"  required>
                    </div>
                    <div class="form-group">
